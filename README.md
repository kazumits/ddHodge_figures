...
This repository provides the Jupyter notebooks that reproduce the results in our preprint of ddHodge [TBA].
...
Showing an example of an artificial dynamics in 3D and performing velocity embedding:
...
Validation of ddHodge in higher dimensional dynamics, such as artificial dynamics on a sphere and Lorenz system:
...
For Figure 4-5, some of the public data are needed to reproduce our results. The small size (< 20MB) of the pre-processed data has been uploaded to the [data](data/) directory.
...
For Figure 1-3, the notbooks are self-contained. No additional files were required.